...
class LectureControllerTest {
    ...
    public void setup() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new LectureController(mockService))
                .build();
    }
    ...
    void shouldReturnAddView_whenAddMethodExecuted() throws Exception {
        ...
        Mockito.when(mockService.add(lecture))
                .thenReturn(true);
    ...
    void shouldReturnUpdateView_whenUpdateMethodExecuted() throws Exception {
        ...
        Mockito.when(mockService.update(lecture))
        .thenReturn(true);
    ...
    void shouldReturnEditView_whenEditMethodExecuted() throws Exception {
        ...
        Mockito.when(mockService.getById(lecture.getId()))
        .thenReturn(lecture);
    ...
    void shouldReturnIndexView_whenDeleteMethodExecuted() throws Exception {
        ...
        Mockito.when(mockService.deleteById(lecture.getId()))
        .thenReturn(true);
