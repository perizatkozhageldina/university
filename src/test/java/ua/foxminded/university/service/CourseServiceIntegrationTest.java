...
public class CourseServiceIntegrationTest {
    ...
    void shouldAddAndGetCourse_whenServiceAddAndGetMethodsCalled() {
        ...
        Assert.assertEquals(course.getName(), retrievedCourse.getName());
        Assert.assertEquals(course.getHours(), retrievedCourse.getHours());
        Assert.assertEquals(course.getLevel(), retrievedCourse.getLevel());
    }
